package o1.submarine.ui

import scala.swing.*
import scala.swing.event.*
import javax.swing.UIManager
import o1.submarine.Adventure
...
object AdventureGUI extends SimpleSwingApplication:
  ...
  def top = new MainFrame:
    ...
    this.contents(0).background= Color(10, 6, 128)
    this.turnCounter.background= Color(10, 6, 128)
    this.locationInfo.background=Color(136, 221, 235)
    this.input.background=Color(136, 221, 235)
    this.turnOutput.background=Color(136, 221, 235)
    // Menu:
